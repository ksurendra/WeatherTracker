Feature: Get a measurement
  ...
  @new
  Scenario: Cannot get a measurement that exists but invalid input date format
    # GET /measurements/2015-09-01
    When I get a measurement for "2015-09-01"
    Then the response has a status code of 400

  @new
  Scenario: Cannot get a measurement that exists but invalid input
    # GET /measurements/16.7
    When I get a measurement for "16.7"
    Then the response has a status code of 400